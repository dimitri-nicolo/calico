...
PACKAGES+=" crypto-policies-scripts python3-setuptools-wheel python3-pip-wheel dnf "
PACKAGES+=" nss-sysinit yum libdnf"
...
PACKAGES+=" sqlite-libs-3.26.0-11.el8.i686 sqlite-libs-3.26.0-11.el8.x86_64"
PACKAGES+=" elfutils-default-yama-scope libyaml dbus-common dbus-tools dbus-libs dbus-daemon"

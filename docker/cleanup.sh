...
PACKAGES+=" python3-hawkey python3-libdnf python3-gpg crypto-policies-scripts"
...
PACKAGES+=" squashfs-tools libtasn1 lz4-libs bzip2-libs ca-certificates krb5-libs openssl-libs openssl"

...
{{site.tseeprodname}} components to read from the database (which is their most common
...
For that reason, in larger deployments, {{site.tseeprodname}} will deploy a BGP route
...
In {{site.tseeprodname}}, this BGP component is also most commonly
...
When the [{{site.tseeprodname}} BGP client](#bgp-client-bird) advertises routes

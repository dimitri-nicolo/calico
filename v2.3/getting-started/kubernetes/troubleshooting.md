...
This article contains Kubernetes specific troubleshooting advice for {{site.tseeprodname}} and
...
{{site.tseeprodname}} [workload endpoints]({{site.baseurl}}/{{page.version}}/reference/calicoctl/resources/workloadendpoint) will
...
When using {{site.tseeprodname}} IPAM, IP addresses are assigned from [IP Pools]({{site.baseurl}}/{{page.version}}/reference/calicoctl/resources/ippool).

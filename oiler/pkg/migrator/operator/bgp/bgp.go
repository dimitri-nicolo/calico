...
func (f Operator) Transform(items []v1.BGPLog) []string {
	var result []string
...
func NewOperator(backend bapi.BGPBackend, clusterInfo bapi.ClusterInfo, queryByGeneratedTime bool) Operator {
	return Operator{
		backend:              backend,

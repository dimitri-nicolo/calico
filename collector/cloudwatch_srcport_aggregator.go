...
func NewCloudWatchAggregator(il bool) FlowLogAggregator {
	return &cloudWatchAggregator{
		flowLogs:             make(map[Tuple]FlowLog),
		flMutex:              sync.RWMutex{},
		includeLabels:        il,

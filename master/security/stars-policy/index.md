...
```shell
kubectl create -f {{site.baseurl}}/{{page.version}}/security/stars-policy/manifests/00-namespace.yaml
kubectl create -f {{site.baseurl}}/{{page.version}}/security/stars-policy/manifests/01-management-ui.yaml
kubectl create -f {{site.baseurl}}/{{page.version}}/security/stars-policy/manifests/02-backend.yaml
kubectl create -f {{site.baseurl}}/{{page.version}}/security/stars-policy/manifests/03-frontend.yaml
kubectl create -f {{site.baseurl}}/{{page.version}}/security/stars-policy/manifests/04-client.yaml
```
...
```shell
kubectl create -n stars -f {{site.baseurl}}/{{page.version}}/security/stars-policy/policies/default-deny.yaml
kubectl create -n client -f {{site.baseurl}}/{{page.version}}/security/stars-policy/policies/default-deny.yaml
```
...
```shell
kubectl create -f {{site.baseurl}}/{{page.version}}/security/stars-policy/policies/allow-ui.yaml
kubectl create -f {{site.baseurl}}/{{page.version}}/security/stars-policy/policies/allow-ui-client.yaml
```
...
```shell
kubectl create -f {{site.baseurl}}/{{page.version}}/security/stars-policy/policies/backend-policy.yaml
```
...
```shell
kubectl create -f {{site.baseurl}}/{{page.version}}/security/stars-policy/policies/frontend-policy.yaml
```

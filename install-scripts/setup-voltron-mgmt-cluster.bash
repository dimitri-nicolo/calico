...
'{"spec":{"template":{"spec":{"containers":[{"name":"cnx-manager","image":"gcr.io/unique-caldron-775/cnx/tigera/cnx-manager:cluster-selection","env":[{"name":"CNX_VOLTRON_API_URL","value":"https://127.0.0.1:30003"}]},{"name":"cnx-manager-proxy","image":"gcr.io/unique-caldron-775/cnx/tigera/cnx-manager-proxy:cluster-selection","imagePullPolicy":"Always","env":[{"name":"CNX_KUBE_APISERVER","value":"cnx-voltron-server.calico-monitoring.svc.cluster.local:9443"},{"name":"CNX_COMPLIANCE_SERVER","value":"cnx-voltron-server.calico-monitoring.svc.cluster.local:9443"}],"volumeMounts":[{"mountPath":"/voltron_certs/","name":"cnx-voltron-https"}]},{"name":"tigera-es-proxy","env":[{"name":"LISTEN_ADDR","value":":8443"}],"image":"gcr.io/tigera-dev/cnx/tigera/es-proxy:v2.5.0-mcm0.1"}],"volumes":[{"name":"cnx-voltron-https","secret":{"secretName":"cnx-voltron-https"}}]}}}}'

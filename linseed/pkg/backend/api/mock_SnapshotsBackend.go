...
type mockConstructorTestingTNewMockSnapshotsBackend interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockSnapshotsBackend(t mockConstructorTestingTNewMockSnapshotsBackend) *MockSnapshotsBackend {

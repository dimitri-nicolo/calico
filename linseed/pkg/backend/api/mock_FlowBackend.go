...
func (_m *MockFlowBackend) List(_a0 context.Context, _a1 ClusterInfo, _a2 v1.L3FlowParams) (<-chan []v1.L3Flow, <-chan error) {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 <-chan []v1.L3Flow
	if rf, ok := ret.Get(0).(func(context.Context, ClusterInfo, v1.L3FlowParams) <-chan []v1.L3Flow); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(<-chan []v1.L3Flow)
		}
	}

	var r1 <-chan error
	if rf, ok := ret.Get(1).(func(context.Context, ClusterInfo, v1.L3FlowParams) <-chan error); ok {
		r1 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(1) != nil {

...
type mockConstructorTestingTNewMockClientSetFactory interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockClientSetFactory(t mockConstructorTestingTNewMockClientSetFactory) *MockClientSetFactory {

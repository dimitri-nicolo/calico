...
func NewEndpointRecommendationEngine(
	kcl k8s.Interface, name, namespace, policyTier string, policyOrder *float64,
...
func (ere *recommendationEngine) Recommend() (*Recommendation, error) {
	...
	var name string
	if ere.isNamespacePolicy {
		if err, ok := DoesNamespaceExist(ere.k8sClient, ere.endpointNamespace); err != nil {
		...
		name = GeneratePolicyName(ere.k8sClient, ere.endpointName, ere.endpointNamespace)
	}

...
type mockConstructorTestingTNewMockReportEventFetcher interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockReportEventFetcher(t mockConstructorTestingTNewMockReportEventFetcher) *MockReportEventFetcher {

...
type mockConstructorTestingTNewMockListDestination interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockListDestination(t mockConstructorTestingTNewMockListDestination) *MockListDestination {

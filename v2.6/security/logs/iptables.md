---
title: iptables logs
redirect_from: latest/security/logs/iptables
...
Note that [Denied Packet Metrics](/{{page.version}}/reference/other-install-methods/security/metrics/metrics) are independent of the `DropActionOverride`

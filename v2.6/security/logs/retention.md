...
> **Note**: LogStorage has built-in retention thresholds of 90% for total storage, and 80% for logs (flow and DNS). If either of these are exceeded, the oldest records and logs are removed.
{: .alert .alert-info}

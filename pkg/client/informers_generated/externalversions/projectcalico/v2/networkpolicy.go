	...
	sharedIndexInformer := cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.ProjectcalicoV2().NetworkPolicies(v1.NamespaceAll).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.ProjectcalicoV2().NetworkPolicies(v1.NamespaceAll).Watch(options)
			},
		},
		&calico_v2.NetworkPolicy{},
		resyncPeriod,
...
func (f *networkPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&calico_v2.NetworkPolicy{}, newNetworkPolicyInformer)
}

func (f *networkPolicyInformer) Lister() v2.NetworkPolicyLister {
	return v2.NewNetworkPolicyLister(f.Informer().GetIndexer())
}

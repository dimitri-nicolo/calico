	...
	sharedIndexInformer := cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				return client.CalicoV1().Tiers().List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				return client.CalicoV1().Tiers().Watch(options)
			},
		},
		&calico_v1.Tier{},
		resyncPeriod,
...
func (f *tierInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&calico_v1.Tier{}, newTierInformer)
}

func (f *tierInformer) Lister() v1.TierLister {
	return v1.NewTierLister(f.Informer().GetIndexer())
}

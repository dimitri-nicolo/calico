...
func newEndpointInformer(client clientset.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	sharedIndexInformer := cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				return client.CalicoV1().Endpoints().List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				return client.CalicoV1().Endpoints().Watch(options)
			},
		},
		&calico_v1.Endpoint{},
		resyncPeriod,
...
func (f *endpointInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&calico_v1.Endpoint{}, newEndpointInformer)
}

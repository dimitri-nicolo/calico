...
type PolicyLister interface {
	...
	List(selector labels.Selector) (ret []*calico.Policy, err error)
...
// List lists all Policies in the indexer.
func (s *policyLister) List(selector labels.Selector) (ret []*calico.Policy, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*calico.Policy))
	})
	return ret, err
}
...
type PolicyNamespaceLister interface {
	...
	Get(name string) (*calico.Policy, error)
...
// List lists all Policies in the indexer for a given namespace.
func (s policyNamespaceLister) List(selector labels.Selector) (ret []*calico.Policy, err error) {
...
// Get retrieves the Policy from the indexer for a given namespace and name.
func (s policyNamespaceLister) Get(name string) (*calico.Policy, error) {

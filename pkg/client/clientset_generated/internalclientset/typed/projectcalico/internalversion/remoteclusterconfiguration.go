...
type RemoteClusterConfigurationInterface interface {
	Create(*projectcalico.RemoteClusterConfiguration) (*projectcalico.RemoteClusterConfiguration, error)
	Update(*projectcalico.RemoteClusterConfiguration) (*projectcalico.RemoteClusterConfiguration, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*projectcalico.RemoteClusterConfiguration, error)
	List(opts v1.ListOptions) (*projectcalico.RemoteClusterConfigurationList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *projectcalico.RemoteClusterConfiguration, err error)
...
func (c *remoteClusterConfigurations) Get(name string, options v1.GetOptions) (result *projectcalico.RemoteClusterConfiguration, err error) {
...
func (c *remoteClusterConfigurations) List(opts v1.ListOptions) (result *projectcalico.RemoteClusterConfigurationList, err error) {
...
func (c *remoteClusterConfigurations) Create(remoteClusterConfiguration *projectcalico.RemoteClusterConfiguration) (result *projectcalico.RemoteClusterConfiguration, err error) {
	result = &projectcalico.RemoteClusterConfiguration{}
	err = c.client.Post().
		Resource("remoteclusterconfigurations").
...
func (c *remoteClusterConfigurations) Update(remoteClusterConfiguration *projectcalico.RemoteClusterConfiguration) (result *projectcalico.RemoteClusterConfiguration, err error) {
	result = &projectcalico.RemoteClusterConfiguration{}
	err = c.client.Put().
		Resource("remoteclusterconfigurations").
...
func (c *remoteClusterConfigurations) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *projectcalico.RemoteClusterConfiguration, err error) {
	result = &projectcalico.RemoteClusterConfiguration{}

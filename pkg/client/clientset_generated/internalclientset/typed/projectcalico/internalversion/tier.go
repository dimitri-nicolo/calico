...
type TierInterface interface {
	Create(ctx context.Context, tier *projectcalico.Tier, opts v1.CreateOptions) (*projectcalico.Tier, error)
	Update(ctx context.Context, tier *projectcalico.Tier, opts v1.UpdateOptions) (*projectcalico.Tier, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*projectcalico.Tier, error)
	List(ctx context.Context, opts v1.ListOptions) (*projectcalico.TierList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *projectcalico.Tier, err error)
	TierExpansion
}
...
func (c *tiers) Get(ctx context.Context, name string, options v1.GetOptions) (result *projectcalico.Tier, err error) {
...
func (c *tiers) List(ctx context.Context, opts v1.ListOptions) (result *projectcalico.TierList, err error) {
...
func (c *tiers) Create(ctx context.Context, tier *projectcalico.Tier, opts v1.CreateOptions) (result *projectcalico.Tier, err error) {
	result = &projectcalico.Tier{}
	err = c.client.Post().
		Resource("tiers").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *tiers) Update(ctx context.Context, tier *projectcalico.Tier, opts v1.UpdateOptions) (result *projectcalico.Tier, err error) {
	result = &projectcalico.Tier{}
	err = c.client.Put().
		Resource("tiers").
		Name(tier.Name).
...
func (c *tiers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *projectcalico.Tier, err error) {
	result = &projectcalico.Tier{}

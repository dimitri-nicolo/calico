...
type PacketCaptureInterface interface {
	...
	List(ctx context.Context, opts v1.ListOptions) (*projectcalico.PacketCaptureList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *projectcalico.PacketCapture, err error)
...
func newPacketCaptures(c *ProjectcalicoClient, namespace string) *packetCaptures {
...
func (c *packetCaptures) Get(ctx context.Context, name string, options v1.GetOptions) (result *projectcalico.PacketCapture, err error) {
...
func (c *packetCaptures) List(ctx context.Context, opts v1.ListOptions) (result *projectcalico.PacketCaptureList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &projectcalico.PacketCaptureList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("packetcaptures").
...
func (c *packetCaptures) Create(ctx context.Context, packetCapture *projectcalico.PacketCapture, opts v1.CreateOptions) (result *projectcalico.PacketCapture, err error) {
	result = &projectcalico.PacketCapture{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("packetcaptures").
...
func (c *packetCaptures) Update(ctx context.Context, packetCapture *projectcalico.PacketCapture, opts v1.UpdateOptions) (result *projectcalico.PacketCapture, err error) {
	result = &projectcalico.PacketCapture{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("packetcaptures").
...
func (c *packetCaptures) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *projectcalico.PacketCapture, err error) {
	result = &projectcalico.PacketCapture{}

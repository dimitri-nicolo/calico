...
func (c *FakeHostEndpoints) Get(name string, options v1.GetOptions) (result *projectcalico.HostEndpoint, err error) {
	obj, err := c.Fake.
...
func (c *FakeHostEndpoints) List(opts v1.ListOptions) (result *projectcalico.HostEndpointList, err error) {
	obj, err := c.Fake.
	...
	list := &projectcalico.HostEndpointList{}
...
func (c *FakeHostEndpoints) Create(hostEndpoint *projectcalico.HostEndpoint) (result *projectcalico.HostEndpoint, err error) {
	obj, err := c.Fake.
...
func (c *FakeHostEndpoints) Update(hostEndpoint *projectcalico.HostEndpoint) (result *projectcalico.HostEndpoint, err error) {
	obj, err := c.Fake.
...
func (c *FakeHostEndpoints) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *projectcalico.HostEndpoint, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(hostendpointsResource, name, data, subresources...), &projectcalico.HostEndpoint{})
	if obj == nil {
		return nil, err
	}
	return obj.(*projectcalico.HostEndpoint), err

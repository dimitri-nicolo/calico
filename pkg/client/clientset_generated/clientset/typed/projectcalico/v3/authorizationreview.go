...
type AuthorizationReviewInterface interface {
	Create(*v3.AuthorizationReview) (*v3.AuthorizationReview, error)
	Update(*v3.AuthorizationReview) (*v3.AuthorizationReview, error)
	UpdateStatus(*v3.AuthorizationReview) (*v3.AuthorizationReview, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v3.AuthorizationReview, error)
	List(opts v1.ListOptions) (*v3.AuthorizationReviewList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v3.AuthorizationReview, err error)
...
func (c *authorizationReviews) Get(name string, options v1.GetOptions) (result *v3.AuthorizationReview, err error) {
...
func (c *authorizationReviews) List(opts v1.ListOptions) (result *v3.AuthorizationReviewList, err error) {
...
func (c *authorizationReviews) Create(authorizationReview *v3.AuthorizationReview) (result *v3.AuthorizationReview, err error) {
	result = &v3.AuthorizationReview{}
	err = c.client.Post().
		Resource("authorizationreviews").
...
func (c *authorizationReviews) Update(authorizationReview *v3.AuthorizationReview) (result *v3.AuthorizationReview, err error) {
	result = &v3.AuthorizationReview{}
	err = c.client.Put().
		Resource("authorizationreviews").
...
func (c *authorizationReviews) UpdateStatus(authorizationReview *v3.AuthorizationReview) (result *v3.AuthorizationReview, err error) {
	result = &v3.AuthorizationReview{}
	err = c.client.Put().
		Resource("authorizationreviews").
		Name(authorizationReview.Name).
...
func (c *authorizationReviews) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v3.AuthorizationReview, err error) {
	result = &v3.AuthorizationReview{}

...
func (c *FakeStagedGlobalNetworkPolicies) List(opts v1.ListOptions) (result *v3.StagedGlobalNetworkPolicyList, err error) {
	...
	list := &v3.StagedGlobalNetworkPolicyList{}
...
func (c *FakeStagedGlobalNetworkPolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v3.StagedGlobalNetworkPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(stagedglobalnetworkpoliciesResource, name, data, subresources...), &v3.StagedGlobalNetworkPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v3.StagedGlobalNetworkPolicy), err

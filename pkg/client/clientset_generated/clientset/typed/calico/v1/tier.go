...
type TierInterface interface {
	Create(*v1.Tier) (*v1.Tier, error)
	Update(*v1.Tier) (*v1.Tier, error)
	Delete(name string, options *meta_v1.DeleteOptions) error
	DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error
	Get(name string, options meta_v1.GetOptions) (*v1.Tier, error)
	List(opts meta_v1.ListOptions) (*v1.TierList, error)
	Watch(opts meta_v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.Tier, err error)
	TierExpansion
}
...
func newTiers(c *CalicoV1Client) *tiers {
	return &tiers{
		client: c.RESTClient(),
	}
}
...
func (c *tiers) Create(tier *v1.Tier) (result *v1.Tier, err error) {
	result = &v1.Tier{}
	err = c.client.Post().
		Resource("tiers").
		Body(tier).
...
func (c *tiers) Update(tier *v1.Tier) (result *v1.Tier, err error) {
	result = &v1.Tier{}
	err = c.client.Put().
		Resource("tiers").
		Name(tier.Name).
...
func (c *tiers) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *tiers) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Resource("tiers").
...
func (c *tiers) Get(name string, options meta_v1.GetOptions) (result *v1.Tier, err error) {
	result = &v1.Tier{}
	err = c.client.Get().
		Resource("tiers").
		Name(name).
...
func (c *tiers) List(opts meta_v1.ListOptions) (result *v1.TierList, err error) {
	result = &v1.TierList{}
	err = c.client.Get().
		Resource("tiers").
...
func (c *tiers) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Resource("tiers").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *tiers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.Tier, err error) {
	result = &v1.Tier{}

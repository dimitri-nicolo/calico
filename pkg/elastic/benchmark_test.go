...
var _ = Describe("Benchmark elastic tests", func() {
	var (
		...
		br benchmark.BenchmarksResult

		b1 = &benchmark.Benchmarks{
			Version:   "1.0.0",
			Type:      benchmark.TypeKubernetes,
			Timestamp: time2,
			NodeName:  "node1",
		}
		b2 = &benchmark.Benchmarks{
			Version:   "1.0.1",
			Type:      benchmark.TypeKubernetes,
			Timestamp: time4,
			NodeName:  "node2",
		}
		b3 = &benchmark.Benchmarks{
			Version:   "1.0.1",
			Type:      benchmark.TypeKubernetes,
			Timestamp: time6,
			NodeName:  "node3",
		}
		b4 = &benchmark.Benchmarks{
			Version:   "1.0.2",
			Type:      benchmark.TypeKubernetes,
			Timestamp: time7,
			NodeName:  "node2",
	...
	It("should store and retrieve benchmarks properly", func() {
		...
		Eventually(func() (*benchmark.Benchmarks, error) {
		...
		res := elasticClient.RetrieveLatestBenchmarks(
			context.Background(), benchmark.TypeKubernetes, nil, time3.Time, time8.Time,
		)
		...
		res = elasticClient.RetrieveLatestBenchmarks(
			context.Background(), benchmark.TypeKubernetes, nil, time3.Time, time5.Time,
		)
		...
		res = elasticClient.RetrieveLatestBenchmarks(
			context.Background(), benchmark.TypeKubernetes,
			[]benchmark.Filter{{NodeNames: []string{"node1", "node2"}}}, time1.Time, time8.Time,
		)
		...
		res = elasticClient.RetrieveLatestBenchmarks(
			context.Background(), benchmark.TypeKubernetes,
			[]benchmark.Filter{{Version: "1.0.1", NodeNames: []string{"node3"}}}, time1.Time, time8.Time,
		)
		...
		res = elasticClient.RetrieveLatestBenchmarks(
			context.Background(), benchmark.TypeKubernetes,
			[]benchmark.Filter{{Version: "1.0.1"}}, time1.Time, time8.Time,
		)
		...
		res = elasticClient.RetrieveLatestBenchmarks(
			context.Background(), benchmark.TypeKubernetes,
			[]benchmark.Filter{{Version: "1.0.1"}, {NodeNames: []string{"node1"}}}, time1.Time, time8.Time,
		)

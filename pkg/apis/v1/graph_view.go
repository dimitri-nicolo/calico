...
type GraphView struct {
	...
	Focus []GraphNodeID `json:"focus,omitempty"`

	// Expanded nodes.
	Expanded []GraphNodeID `json:"expanded,omitempty"`
	...
	FollowedEgress  []GraphNodeID `json:"followed_egress,omitempty"`
	FollowedIngress []GraphNodeID `json:"followed_ingress,omitempty"`

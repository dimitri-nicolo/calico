...
func autoConvert_v1_PolicyList_To_calico_PolicyList(in *PolicyList, out *calico.PolicyList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]calico.Policy, len(*in))
		for i := range *in {
			if err := Convert_v1_Policy_To_calico_Policy(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_calico_PolicyList_To_v1_PolicyList(in *calico.PolicyList, out *PolicyList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]Policy, len(*in))
		for i := range *in {
			if err := Convert_calico_Policy_To_v1_Policy(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1_TierList_To_calico_TierList(in *TierList, out *calico.TierList, s conversion.Scope) error {
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]calico.Tier, len(*in))
		for i := range *in {
			if err := Convert_v1_Tier_To_calico_Tier(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_calico_TierList_To_v1_TierList(in *calico.TierList, out *TierList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]Tier, len(*in))
		for i := range *in {
			if err := Convert_calico_Tier_To_v1_Tier(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {

...
// get the key root to be passed to a calico resource based storage Interface.
//
// It is meant to be passed to a Store's KeyRootFunc field, so that a calico based storage interface
...
// get the key to be passed to a calico resource based storage Interface.
//

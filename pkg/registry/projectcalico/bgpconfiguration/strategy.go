...
func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, bool, error) {
	...
	if !ok {
		return nil, nil, false, fmt.Errorf("given object is not a BGP Configuration")
	}
	return labels.Set(apiserver.ObjectMeta.Labels), BGPConfigurationToSelectableFields(apiserver), apiserver.Initializers != nil, nil
}

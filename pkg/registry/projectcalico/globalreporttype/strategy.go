...
func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, bool, error) {
	...
	if !ok {
		return nil, nil, false, fmt.Errorf("given object (type: %v) is not a Global Report Type", reflect.TypeOf(obj))
	}
	return labels.Set(apiserver.ObjectMeta.Labels), GlobalReportTypeToSelectableFields(apiserver), apiserver.Initializers != nil, nil
}

...
func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, bool, error) {
	...
	if !ok {
		return nil, nil, false, fmt.Errorf("given object (type: %v) is not a Host Endpoint", reflect.TypeOf(obj))
	}
	return labels.Set(apiserver.ObjectMeta.Labels), HostEndpointToSelectableFields(apiserver), apiserver.Initializers != nil, nil
}

...
func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, bool, error) {
	...
	if !ok {
		return nil, nil, false, fmt.Errorf("given object (type %v) is not a Cluster Information", reflect.TypeOf(obj))
	}
	return labels.Set(apiserver.ObjectMeta.Labels), ClusterInformationToSelectableFields(apiserver), apiserver.Initializers != nil, nil
}

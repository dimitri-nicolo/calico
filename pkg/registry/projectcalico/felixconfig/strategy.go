...
func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, bool, error) {
	...
	if !ok {
		return nil, nil, false, fmt.Errorf("given object is not a FelixConfiguration")
	}
	return labels.Set(apiserver.ObjectMeta.Labels), FelixConfigurationToSelectableFields(apiserver), apiserver.Initializers != nil, nil
}

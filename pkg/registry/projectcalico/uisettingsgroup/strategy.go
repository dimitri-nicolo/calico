...
func (apiServerStrategy) ValidateUpdate(ctx context.Context, obj, old runtime.Object) field.ErrorList {
	return ValidateUISettingsGroupUpdate(obj.(*calico.UISettingsGroup), old.(*calico.UISettingsGroup))
}

func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, error) {
	apiserver, ok := obj.(*calico.UISettingsGroup)
	if !ok {
		return nil, nil, fmt.Errorf("given object (type %v) is not a UISettingsGroup Set", reflect.TypeOf(obj))
	}
...
func ValidateUISettingsGroupUpdate(update, old *calico.UISettingsGroup) field.ErrorList {

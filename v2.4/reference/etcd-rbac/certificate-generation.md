...
The certificates for {{site.tseeprodname}}, Kubernetes, or any other component can be
...
See [this](kubernetes) for how to provide certificates to Kubernetes and {{site.tseeprodname}}
components.

...
func StartDataplaneDriver(configParams *config.Config,
	...
	if configParams.UseInternalDataplaneDriver {
		...
		dpConfig := intdataplane.Config{
			...
			CloudWatchLogsAggregationKindAllowed: configParams.CloudWatchLogsAggregationKindAllowed,
			CloudWatchLogsAggregationKindDenied:  configParams.CloudWatchLogsAggregationKindDenied,

...
func StartDataplaneDriver(configParams *config.Config, healthAggregator *health.HealthAggregator) (DataplaneDriver, *exec.Cmd) {
	if configParams.UseInternalDataplaneDriver {
		...
		dpConfig := intdataplane.Config{
			...
			CNXMetricsEnabled:              configParams.CNXMetricsEnabled,
			CNXMetricsPrometheusPort:       configParams.CNXMetricsPrometheusPort,
			CNXPrometheusCertFile:          configParams.CNXPrometheusCertFile,
			CNXPrometheusKeyFile:           configParams.CNXPrometheusKeyFile,
			CNXPrometheusCAFile:            configParams.CNXPrometheusCAFile,

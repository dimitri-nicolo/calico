...
require (
	...
	github.com/tigera/licensing v1.0.1-0.20210414175711-2c61aca0ed39
...
replace (
	github.com/projectcalico/cni-plugin => github.com/tigera/cni-plugin-private v1.11.1-0.20210414205239-8bf6837a28f1

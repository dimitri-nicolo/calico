...
require (
	...
	github.com/tigera/compliance v0.0.0-20210709012922-d518d81d1541
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20210709011444-86b1ba7b9f55

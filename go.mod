...
require (
	...
	github.com/tigera/licensing v1.0.1-0.20200103202009-cd8a8b68f3ac
...
replace (
	...
	github.com/projectcalico/libcalico-go => github.com/projectcalico/libcalico-go v0.0.0-20200102185429-756777256bb8

...
replace (
	...
	github.com/tigera/compliance => github.com/tigera/compliance v0.0.0-20210123060127-d4708e3ddfed
	github.com/tigera/lma => github.com/tigera/lma v0.0.0-20210123055238-d8d5fc8836c7

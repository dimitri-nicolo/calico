...
require (
	...
	github.com/tigera/lma v0.0.0-20210510231249-8762ebbfda71
...
replace (
	...
	github.com/projectcalico/libcalico-go => github.com/tigera/libcalico-go-private v1.7.2-0.20210510230657-4f535f176bc5 // indirect

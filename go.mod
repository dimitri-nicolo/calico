...
require (
	...
	github.com/tigera/compliance v0.0.0-20210910000404-cb3ab64392c3
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20210910000252-b26c0918cb9b

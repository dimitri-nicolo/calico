...
require (
	...
	github.com/tigera/compliance v0.0.0-20210521010019-a9e9d1e71572
...
replace (
	...
	github.com/projectcalico/typha => github.com/tigera/typha-private v0.6.0-beta1.0.20210521111009-06d8168b99f1

...
require (
	...
	github.com/tigera/compliance v0.0.0-20210618181423-ce12e72b9244
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20210617225347-58906133814d

...
require (
	...
	github.com/tigera/compliance v0.0.0-20210526201203-b86a5316440b
...
replace (
	...
	github.com/projectcalico/felix => github.com/tigera/felix-private v0.0.0-20210527160109-f9f9ff921db2

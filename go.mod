...
replace (
	github.com/projectcalico/libcalico-go => github.com/tigera/libcalico-go-private v1.7.2-0.20200921215509-6b4c1f93d5eb // indirect
...
require (
	...
	github.com/tigera/apiserver v0.0.0-20200921231118-75f006459034
	k8s.io/api v0.17.3

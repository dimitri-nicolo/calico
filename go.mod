...
replace (
	...
	github.com/tigera/licensing => github.com/tigera/licensing v1.0.1-0.20211025192148-766e4c019006
...
replace github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20211025223948-f6e35c4903ac

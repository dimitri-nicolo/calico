...
replace (
	github.com/projectcalico/libcalico-go => github.com/tigera/libcalico-go-private v1.7.2-0.20200909145021-06f139c95d08 // indirect
...
require (
	...
	github.com/tigera/apiserver v0.0.0-20200822180901-58c7fe5f3387
	k8s.io/api v0.17.3

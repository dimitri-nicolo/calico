...
replace (
	github.com/projectcalico/felix => github.com/tigera/felix-private v0.0.0-20210123053843-da28ff83236f
	...
	github.com/tigera/compliance => github.com/tigera/compliance v0.0.0-20210123064217-c89601c8573a

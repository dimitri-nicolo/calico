...
replace (
	...
	github.com/projectcalico/libcalico-go => github.com/tigera/libcalico-go-private v1.7.2-0.20201020123634-54f455282ce3
	...
	github.com/tigera/lma => github.com/tigera/lma v0.0.0-20201020124213-81926f15c925

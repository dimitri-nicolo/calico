...
require (
	...
	github.com/tigera/lma v0.0.0-20210617170141-723cb9adb712
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20210617165602-bd9c6697d1ec // indirect

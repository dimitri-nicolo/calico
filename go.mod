...
require (
	...
	github.com/tigera/compliance v0.0.0-20210823175634-ccf05fb4af8f
...
replace (
	...
	github.com/projectcalico/felix => github.com/tigera/felix-private v0.0.0-20210823174837-b0065ee1e5a7

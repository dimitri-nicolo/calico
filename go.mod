...
require (
	...
	github.com/tigera/lma v0.0.0-20210503002212-10967889b202
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20210503001623-3a2a8ffd39f4 // indirect

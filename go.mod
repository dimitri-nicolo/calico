...
require (
	...
	github.com/tigera/compliance v0.0.0-20210823130552-f8a678526ed5
...
replace (
	...
	github.com/projectcalico/felix => github.com/tigera/felix-private v0.0.0-20210823125228-fc2165c767ff

...
require (
	...
	github.com/tigera/compliance v0.0.0-20210810190406-b67b30db70d5
...
replace (
	...
	github.com/projectcalico/felix => github.com/tigera/felix-private v0.0.0-20210810185120-2065ab3c6159

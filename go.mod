...
require (
	...
	github.com/tigera/licensing v2.7.0-0.dev+incompatible
...
replace (
	github.com/projectcalico/libcalico-go => github.com/tigera/libcalico-go-private v1.7.2-0.20191107025257-fdda32d56026

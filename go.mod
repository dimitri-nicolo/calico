...
require (
	...
	github.com/tigera/compliance v0.0.0-20210824213345-7876aac7e4ff
...
replace (
	...
	github.com/projectcalico/felix => github.com/tigera/felix-private v0.0.0-20210824212152-591ce4c66d37

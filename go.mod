...
require (
	...
	github.com/tigera/compliance v0.0.0-20210805040615-b65c63d76a6f
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20210805040132-40e8f2bac340

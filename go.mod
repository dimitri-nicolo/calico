...
require (
	...
	github.com/tigera/compliance v0.0.0-20211029222209-f2fd61860bdc
...
replace (
	...
	github.com/projectcalico/felix => github.com/tigera/felix-private v0.0.0-20211029220957-b99e877bd0d6

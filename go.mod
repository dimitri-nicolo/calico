...
replace (
	github.com/projectcalico/libcalico-go => github.com/tigera/libcalico-go-private v1.7.2-0.20210123222942-eedf2a1677e9 // indirect
...
require (
	...
	github.com/tigera/apiserver v0.0.0-20210123222553-73e8896a86f2

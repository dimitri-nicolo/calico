...
require (
	...
	github.com/tigera/compliance v0.0.0-20210817015358-a5440b665ed6
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20210817005523-00a655153c2e

...
replace (
	...
	github.com/tigera/licensing => github.com/tigera/licensing v1.0.1-0.20211026000238-d5b51cfec701
...
replace github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20211026000503-cb6438107893

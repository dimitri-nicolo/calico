...
require (
	...
	github.com/tigera/api v0.0.0-20210802134241-853db8f8169b
...
replace (
	github.com/projectcalico/libcalico-go => github.com/tigera/libcalico-go-private v1.7.2-0.20210802142643-12d925ea400c

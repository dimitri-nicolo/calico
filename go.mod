...
replace (
	github.com/projectcalico/libcalico-go => github.com/tigera/libcalico-go-private v1.7.2-0.20210304001007-db463d567870 // indirect
...
require (
	...
	github.com/tigera/apiserver v0.0.0-20210305163939-5088de0fbab0

...
replace (
	...
	github.com/tigera/licensing => github.com/tigera/licensing v1.0.1-0.20211123175947-bfcd3560194d
...
replace github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20211123172448-23b9c197dee1

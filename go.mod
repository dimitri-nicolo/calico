...
require (
	...
	github.com/tigera/compliance v0.0.0-20211109101829-f80144323d12
...
replace (
	...
	github.com/projectcalico/felix => github.com/tigera/felix-private v0.0.0-20211109100407-d39315b6cd9e

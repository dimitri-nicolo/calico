...
replace (
	github.com/projectcalico/libcalico-go => github.com/tigera/libcalico-go-private v1.7.2-0.20210419124135-41d11f202068 // indirect
...
require (
	...
	github.com/tigera/lma v0.0.0-20210419125145-1246a6d84ff5

...
require (
	...
	github.com/tigera/lma v0.0.0-20210617045159-f826c43eb227
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20210617044425-6446d8fd133e // indirect

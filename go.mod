...
replace (
	github.com/projectcalico/felix => github.com/tigera/felix-private v0.0.0-20200522041845-dff8eefbf4ac
	...
	github.com/tigera/compliance => github.com/tigera/compliance v0.0.0-20200523010952-de0b0228c5e4

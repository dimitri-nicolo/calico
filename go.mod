...
require (
	...
	github.com/tigera/licensing v0.0.0-00010101000000-000000000000
...
replace (
	...
	github.com/tigera/licensing => github.com/tigera/licensing v1.0.1-0.20200617233549-fa90126a1814

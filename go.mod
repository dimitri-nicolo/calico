...
replace (
	github.com/projectcalico/libcalico-go => github.com/tigera/libcalico-go-private v1.7.2-0.20210416175331-1d353f9b9a02 // indirect
...
require (
	...
	github.com/tigera/lma v0.0.0-20210416175902-d4c1c581fa99

...
require (
	...
	github.com/tigera/compliance v0.0.0-20210712180913-ddb0e6e424f0
...
replace (
	...
	github.com/projectcalico/felix => github.com/tigera/felix-private v0.0.0-20210712175643-a82cdca95f0a

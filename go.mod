...
require (
	...
	github.com/tigera/compliance v0.0.0-20210809153041-f1f0a694443f
...
replace (
	...
	github.com/projectcalico/felix => github.com/tigera/felix-private v0.0.0-20210809122020-6125abbc2888

...
require (
	...
	github.com/tigera/compliance v0.0.0-20210618185342-5f29e9e75561
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20210618185056-1c37a9f46bb9

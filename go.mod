...
require (
	...
	github.com/tigera/compliance v0.0.0-20210714004626-107230728cde
...
replace (
	...
	github.com/projectcalico/felix => github.com/tigera/felix-private v0.0.0-20210714003555-7328334e7ddb

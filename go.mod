...
require (
	...
	github.com/tigera/lma v0.0.0-20210531205419-6406fcbf9e58
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20210531204841-f281c884e1fd // indirect

...
require (
	...
	github.com/tigera/api v0.0.0-20211117221641-7c93a2f44ce3
...
replace (
	github.com/projectcalico/cni-plugin => github.com/tigera/cni-plugin-private v1.11.1-0.20211117054424-60e0389bcead

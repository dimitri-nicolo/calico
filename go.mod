...
require (
	...
	github.com/tigera/compliance v0.0.0-20220118173936-37d80dd4de94
...
replace (
	github.com/projectcalico/calico => github.com/tigera/calico-private v1.11.0-cni-plugin-private.0.20220117182628-77f56ff2c9e7

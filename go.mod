...
replace (
	github.com/projectcalico/libcalico-go => github.com/tigera/libcalico-go-private v1.7.2-0.20201215061722-3d90f1306e73 // indirect
...
require (
	...
	github.com/tigera/apiserver v0.0.0-20201218034220-dc96863a7f2b

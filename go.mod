...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20211123184439-eeb378caa5b6
...
require (
	...
	github.com/tigera/lma v0.0.0-20211123185205-900c3a844d68

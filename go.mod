...
require (
	...
	github.com/tigera/api v0.0.0-20210803031358-81412a025e69
...
replace (
	github.com/projectcalico/libcalico-go => github.com/tigera/libcalico-go-private v1.7.2-0.20210803031519-4b038c971be4

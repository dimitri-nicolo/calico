...
require (
	...
	github.com/tigera/lma v0.0.0-20210601165222-cbb681a8f189
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20210601164339-79969c038128 // indirect

...
replace (
	github.com/projectcalico/cni-plugin => github.com/tigera/cni-plugin-private v1.11.1-0.20211011104050-f6fec26e0556
	github.com/projectcalico/felix => github.com/tigera/felix-private v0.0.0-20211011122511-984092470e09

...
replace (
	github.com/projectcalico/libcalico-go => github.com/tigera/libcalico-go-private v1.7.2-0.20200505094137-67e5bb69f02d // indirect
...
require (
	...
	github.com/tigera/apiserver v0.0.0-20200421235523-112604167a7b
	k8s.io/api v0.17.3

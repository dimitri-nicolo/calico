...
require (
	...
	github.com/tigera/compliance v0.0.0-20210617042457-250acefc009d
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20210617041623-c65f29258ce0

...
require (
	...
	github.com/tigera/lma v0.0.0-20210816204750-65c2b526297d
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20210816204101-6ad7fdd5b297

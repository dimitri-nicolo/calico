...
require (
	...
	github.com/tigera/compliance v0.0.0-20220118201034-fa9ef8b0bc8a
...
replace (
	github.com/projectcalico/calico => github.com/tigera/calico-private v1.11.0-cni-plugin-private.0.20220119201525-245d1ffa1dfd

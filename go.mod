...
replace (
	...
	github.com/projectcalico/felix => github.com/tigera/felix-private v0.0.0-20201008183237-900beef3e8ee
...
require (
	...
	github.com/tigera/apiserver v0.0.0-20201008163230-aba2eda177ed

...
replace (
	...
	github.com/tigera/compliance => github.com/tigera/compliance v0.0.0-20200416083951-f029c62997a5
	github.com/tigera/lma => github.com/tigera/lma v0.0.0-20200415190504-f82e57a0ab4c

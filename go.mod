...
replace (
	github.com/projectcalico/libcalico-go => github.com/tigera/libcalico-go-private v1.7.2-0.20200915233301-645e99934038 // indirect
...
require (
	...
	github.com/tigera/apiserver v0.0.0-20200921183808-3140f7a82bf2
	k8s.io/api v0.17.3

...
replace (
	github.com/projectcalico/libcalico-go => github.com/tigera/libcalico-go-private v1.7.2-0.20200820223007-9d2762af4e17 // indirect
...
require (
	...
	github.com/tigera/apiserver v0.0.0-20200820225551-1ca928978af5
	k8s.io/api v0.17.3

...
require (
	...
	github.com/tigera/lma v0.0.0-20210617042154-2ed5a763fb13
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20210617041623-c65f29258ce0 // indirect

...
require (
	...
	github.com/tigera/lma v0.0.0-20210805012015-762c38b5a51f
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20210805011410-c11bcc78b80a // indirect

...
replace (
	github.com/projectcalico/libcalico-go => github.com/tigera/libcalico-go-private v1.7.2-0.20201005223636-e17ed7aae6e1 // indirect
...
require (
	...
	github.com/tigera/apiserver v0.0.0-20201007181940-f3ac5c08450f
	k8s.io/api v0.17.3

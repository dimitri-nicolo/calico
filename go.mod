...
replace (
	github.com/projectcalico/felix => github.com/tigera/felix-private v0.0.0-20201020222804-a47f313c1383
	...
	github.com/tigera/compliance => github.com/tigera/compliance v0.0.0-20201021081044-59bcc7330f40

...
require (
	...
	github.com/tigera/compliance v0.0.0-20210819134754-eff07518d6e3
...
replace (
	...
	github.com/projectcalico/felix => github.com/tigera/felix-private v0.0.0-20210819133347-517ff5366ed3

...
replace (
	...
	github.com/tigera/apiserver => github.com/tigera/apiserver v0.0.0-20200721162321-07e9b6f4f49f
	github.com/tigera/compliance => github.com/tigera/compliance v0.0.0-20200721081514-d3d54e2b470c

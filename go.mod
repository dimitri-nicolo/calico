...
require (
	...
	github.com/tigera/compliance v0.0.0-20210629041658-5d65d6f7ddc8
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20210629035729-c63351a48df2

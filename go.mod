...
replace (
	...
	github.com/projectcalico/felix => github.com/tigera/felix-private v0.0.0-20200124222406-29678b628196
...
require (
	...
	github.com/tigera/lma v0.0.0-20200124190638-c2407a991fff

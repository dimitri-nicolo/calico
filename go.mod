...
replace (
	github.com/projectcalico/libcalico-go => github.com/tigera/libcalico-go-private v1.7.2-0.20200817154828-da396a0be1d4 // indirect
...
require (
	...
	github.com/tigera/apiserver v0.0.0-20200817183508-d3e4197f7cd6
	k8s.io/api v0.17.3

...
replace (
	...
	github.com/tigera/licensing => github.com/tigera/licensing v1.0.1-0.20211202183818-931c56b0874e
...
replace github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20211126153335-1e65a3ead8be

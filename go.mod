...
require (
	...
	github.com/tigera/lma v0.0.0-20210617173241-f812c33fbd3b
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20210617173247-85c6e7d3e848 // indirect

...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20211110183156-860e24e19e40
...
require (
	...
	github.com/tigera/lma v0.0.0-20211110184014-f9582911c8e3

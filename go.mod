...
replace (
	github.com/projectcalico/libcalico-go => github.com/tigera/libcalico-go-private v1.7.2-0.20201211113819-549cd8cda512 // indirect
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.18.12
	k8s.io/sample-controller => k8s.io/sample-controller v0.18.12
)
...
require (
	...
	github.com/tigera/apiserver v0.0.0-20201214213325-8be4490ef775
	github.com/tigera/lma v0.0.0-20201214223844-256ce19bfc05

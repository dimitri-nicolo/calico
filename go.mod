...
replace (
	...
	github.com/tigera/licensing => github.com/tigera/licensing v1.0.1-0.20211105031908-d59f5204df97
...
replace github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20211105034335-888aaae3a76e

...
require (
	...
	github.com/tigera/lma v0.0.0-20211207205952-0480214223ff
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20211207201004-2c05afd2798d // indirect

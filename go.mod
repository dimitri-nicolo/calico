...
require (
	...
	github.com/tigera/compliance v0.0.0-20210805041756-ed05e3bf4a68
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20210805041029-16a66f49f51b

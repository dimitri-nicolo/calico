...
require (
	...
	github.com/tigera/compliance v0.0.0-20210823173448-afe11059f3ac
...
replace (
	...
	github.com/projectcalico/felix => github.com/tigera/felix-private v0.0.0-20210823172332-7e592c7da5d3

...
replace (
	github.com/projectcalico/felix => github.com/tigera/felix-private v0.0.0-20200514164432-a7fa66265913
	...
	github.com/tigera/compliance => github.com/tigera/compliance v0.0.0-20200515081354-d56614d9a174

...
require (
	...
	github.com/tigera/compliance v0.0.0-20210913160857-6f3ad4e6f2ed
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20210910153003-9f808458c145

...
require (
	...
	github.com/tigera/lma v0.0.0-20211207195434-76ffa4b4c69a
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20211207194610-b64281f07486 // indirect

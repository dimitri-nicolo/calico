...
require (
	...
	github.com/tigera/lma v0.0.0-20211119230010-201132db194b
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20211119225301-7611fb0d3627 // indirect

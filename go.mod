...
replace (
	...
	github.com/projectcalico/felix => github.com/tigera/felix-private v0.0.0-20210816193823-38b350839e4c
...
require (
	...
	github.com/tigera/api v0.0.0-20210816180225-57c7161ec6a5 // indirect

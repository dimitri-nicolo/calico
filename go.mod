...
require (
	...
	github.com/tigera/api v0.0.0-20210805182922-ad16e584d37b
...
replace (
	github.com/projectcalico/apiserver => github.com/tigera/apiserver v0.0.0-20210805041029-16a66f49f51b // indirect

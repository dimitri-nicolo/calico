...
MAPPED_COMPONENTS = {
    'cnx-manager': 'manager',
    'voltron': 'calico-private',
    'cnx-apiserver': 'calico-private',
    'cnx-queryserver': 'calico-private',
    ...
    'compliance-controller': 'calico-private',
    'compliance-reporter': 'calico-private',
    'compliance-snapshotter': 'calico-private',
    'compliance-server': 'calico-private',
    'compliance-benchmarker': 'calico-private',
    'ingress-collector': 'ingress-collector',
    'l7-collector': 'calico-private',
    'envoy-init': 'l7-collector',
    'envoy': 'envoy-docker',
    'tigera-cni': 'calico-private',
    'license-agent': 'calico-private',
    'firewall-integration': 'calico-private',
    'egress-gateway': 'calico-private',
    'guardian': 'calico-private',
    'dex': 'dexidp-docker',
    'honeypod-controller': 'calico-private',
    'anomaly_detection_jobs': 'anomaly-detection',
    'anomaly-detection-api': 'calico-private',
    'elasticsearch-metrics': 'elasticsearch-metrics',
    'packetcapture': 'calico-private',
    'tigera-prometheus-service': 'calico-private',

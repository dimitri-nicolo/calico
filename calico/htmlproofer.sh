...
HP_IGNORE_URLS="/docs.openshift.org/,/docs.openshift.com/,#,/github.com\/projectcalico\/calico\/releases\/download/,/v2.3/,/v2.4/,/v2.5/,/v2.6/,/eksctl.io/,/stackpoint.io/,/api.my-ocp-domain.com/,/docs.vmware.com/,/github.com\/projectcalico\/felix\/issues\/1347/"

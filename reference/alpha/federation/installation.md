...
- {{site.prodname}} standalone clusters (or multi-clustered management (MCM) clusters). For help, see the [Quickstart quide]({{site.baseurl}}/getting-started/kubernetes/quickstart#install-kubernetes) or [Multi-cluster management]({{site.baseurl}}/maintenance/mcm/).

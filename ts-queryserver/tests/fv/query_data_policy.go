...
func policyTestQueryData() []testQueryData {
	...
	qcPolicy_gnp2_t1_all_res.Ingress[1].Source.NumHostEndpoints = 4
	qcPolicy_gnp2_t1_all_res.Ingress[1].Source.NumWorkloadEndpoints = 4
	...
	qcPolicy_sgnp2_t1_all_res.Ingress[0].Destination.NumHostEndpoints = 2
	qcPolicy_sgnp2_t1_all_res.Ingress[0].Destination.NumWorkloadEndpoints = 0
	qcPolicy_sgnp2_t1_all_res.Ingress[1].Destination.NumHostEndpoints = 2
	qcPolicy_sgnp2_t1_all_res.Ingress[1].Destination.NumWorkloadEndpoints = 1
	qcPolicy_sgnp2_t1_all_res.Ingress[1].Source.NumHostEndpoints = 4
	qcPolicy_sgnp2_t1_all_res.Ingress[1].Source.NumWorkloadEndpoints = 4
	qcPolicy_sgnp2_t1_all_res.Egress[0].Source.NumHostEndpoints = 4
	qcPolicy_sgnp2_t1_all_res.Egress[0].Source.NumWorkloadEndpoints = 2
	qcPolicy_sgnp2_t1_all_res.Egress[1].Source.NumHostEndpoints = 1
	qcPolicy_sgnp2_t1_all_res.Egress[1].Source.NumWorkloadEndpoints = 1
	...
	qcPolicy_gnp2_t1_all_res_fewer.Ingress[0].Source.NumHostEndpoints = 4
	qcPolicy_gnp2_t1_all_res_fewer.Ingress[0].Source.NumWorkloadEndpoints = 4
	...
	qcPolicy_gnp2_t1_all_res_fewer_updated_wep1.Ingress[0].Source.NumHostEndpoints = 4
	qcPolicy_gnp2_t1_all_res_fewer_updated_wep1.Ingress[0].Source.NumWorkloadEndpoints = 4
	...
	qcPolicy_gnp2_t1_no_ns2_no_rackless.Ingress[1].Source.NumHostEndpoints = 3
	qcPolicy_gnp2_t1_no_ns2_no_rackless.Ingress[1].Source.NumWorkloadEndpoints = 2
	...
	qcPolicy_gnp2_t1_all_res_with_index.Ingress[1].Source.NumHostEndpoints = 4
	qcPolicy_gnp2_t1_all_res_with_index.Ingress[1].Source.NumWorkloadEndpoints = 4
	...
	qcPolicy_sgnp2_t1_all_res_with_index.Ingress[0].Destination.NumHostEndpoints = 2
	qcPolicy_sgnp2_t1_all_res_with_index.Ingress[0].Destination.NumWorkloadEndpoints = 0
	qcPolicy_sgnp2_t1_all_res_with_index.Ingress[1].Destination.NumHostEndpoints = 2
	qcPolicy_sgnp2_t1_all_res_with_index.Ingress[1].Destination.NumWorkloadEndpoints = 1
	qcPolicy_sgnp2_t1_all_res_with_index.Ingress[1].Source.NumHostEndpoints = 4
	qcPolicy_sgnp2_t1_all_res_with_index.Ingress[1].Source.NumWorkloadEndpoints = 4
	qcPolicy_sgnp2_t1_all_res_with_index.Egress[0].Source.NumHostEndpoints = 4
	qcPolicy_sgnp2_t1_all_res_with_index.Egress[0].Source.NumWorkloadEndpoints = 2
	qcPolicy_sgnp2_t1_all_res_with_index.Egress[1].Source.NumHostEndpoints = 1
	qcPolicy_sgnp2_t1_all_res_with_index.Egress[1].Source.NumWorkloadEndpoints = 1

	qcpolicy_gnp2_t1_o4_rack2_only_networkset := qcPolicy(gnp2_t1_o4_rack2_only, 1, 0, 1, 0)
	qcpolicy_gnp2_t1_o4_rack2_only_networkset.Ingress[0].Source.NumHostEndpoints = 0
	qcpolicy_gnp2_t1_o4_rack2_only_networkset.Ingress[0].Source.NumWorkloadEndpoints = 0
	qcpolicy_gnp2_t1_o4_rack2_only_networkset.Egress[1].Destination.NumHostEndpoints = 0
	qcpolicy_gnp2_t1_o4_rack2_only_networkset.Egress[1].Destination.NumWorkloadEndpoints = 0

	qcpolicy_sgnp2_t1_o4_rack2_only_networkset := qcPolicy(sgnp2_t1_o4_rack2_only, 1, 0, 1, 0)
	qcpolicy_sgnp2_t1_o4_rack2_only_networkset.Ingress[0].Source.NumHostEndpoints = 0
	qcpolicy_sgnp2_t1_o4_rack2_only_networkset.Ingress[0].Source.NumWorkloadEndpoints = 0
	qcpolicy_sgnp2_t1_o4_rack2_only_networkset.Egress[1].Destination.NumHostEndpoints = 0
	qcpolicy_sgnp2_t1_o4_rack2_only_networkset.Egress[1].Destination.NumWorkloadEndpoints = 0

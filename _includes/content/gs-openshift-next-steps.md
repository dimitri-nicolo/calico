...
We recommend installing `calicoq` as a container in OpenShift. Refer to [Installing calicoq as a container on a single host]({{site.baseurl}}/getting-started/clis/calicoq/#install-calicoq-as-a-container-on-a-single-host) for instructions.

...
- {{site.tseeprodname}} must be able to manage `cali*` interfaces on the host. When IPIP is
  ...
  > [Preventing NetworkManager from controlling {{site.tseeprodname}} interfaces]({{site.baseurl}}/{{page.version}}/maintenance/troubleshooting#prevent-networkmanager-from-controlling-{{site.tseeprodnamedash}}-interfaces)

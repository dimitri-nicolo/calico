...
// MockAnomalyDetectionController is an autogenerated mock type for the MockAnomalyDetectionController type
...
// StopADForCluster provides a mock function with given fields: clusterName
func (_m *MockAnomalyDetectionController) StopADForCluster(clusterName string) {

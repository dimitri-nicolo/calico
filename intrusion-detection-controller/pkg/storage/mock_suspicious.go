...
func (m MockSuspicious) QuerySet(ctx context.Context, geoDB geodb.GeoDatabase, maxLinseedTimeSkew time.Duration, feed *apiV3.GlobalThreatFeed) ([]v1.Event, time.Time, string, error) {

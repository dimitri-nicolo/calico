...
func (m *MockSetQuerier) QueryIPSet(ctx context.Context, geoDB geodb.GeoDatabase, maxLinseedTimeSkew time.Duration, feed *apiV3.GlobalThreatFeed) (Iterator[v1.FlowLog], string, error) {

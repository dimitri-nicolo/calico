...
func main() {
	...
	indexSettings := elastic.IndexSettings{
		Replicas: elastic.DefaultReplicas,
		Shards:   elastic.DefaultShards,
	}
	...
	e, err := elastic.NewElasticWithIndexSettings(h, u, user, pass, indexSettings)
	if err != nil {

...
func NewPolicyRecommendationScopeStorage(opts Options) (registry.DryRunnableStorage, factory.DestroyFunc) {
	...
	dryRunnableStorage := registry.DryRunnableStorage{Storage: &resourceStore{
		...
		aapiListType:      reflect.TypeOf(v3.PolicyRecommendationScopeList{}),
		libCalicoType:     reflect.TypeOf(v3.PolicyRecommendationScope{}),
		libCalicoListType: reflect.TypeOf(v3.PolicyRecommendationScopeList{}),
		isNamespaced:      false,
		create:            createFn,
		update:            updateFn,
		get:               getFn,

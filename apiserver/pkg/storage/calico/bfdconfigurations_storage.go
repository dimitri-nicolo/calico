...
func NewBFDConfigurationStorage(opts Options) (registry.DryRunnableStorage, factory.DestroyFunc) {
	...
	dryRunnableStorage := registry.DryRunnableStorage{Storage: &resourceStore{
		...
		aapiType:          reflect.TypeOf(v3.BFDConfiguration{}),
		aapiListType:      reflect.TypeOf(v3.BFDConfigurationList{}),
		libCalicoType:     reflect.TypeOf(v3.BFDConfiguration{}),
		libCalicoListType: reflect.TypeOf(v3.BFDConfigurationList{}),
		isNamespaced:      false,
		create:            createFn,
		update:            updateFn,
		get:               getFn,

...
func (apiServerStrategy) PrepareForCreate(ctx context.Context, obj runtime.Object) {
	...
	deeppacketinspection.Status = v3.DeepPacketInspectionStatus{}
}
...
func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, error) {
	...
	return labels.Set(apiserver.ObjectMeta.Labels), DeepPacketInspectionToSelectableFields(apiserver), nil
}

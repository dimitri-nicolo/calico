...
2. Install Calico on Kubernetes:
  ...
  - If Calico is already installed on Kubernetes, verify that [Calico networking]({{site.baseurl}}/{{page.version}}/getting-started/kubernetes/) (or a non-Calico CNI) and Calico network policy are installed.

...
func (c *FakePolicyRecommendationScopes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v3.PolicyRecommendationScope, err error) {
	emptyResult := &v3.PolicyRecommendationScope{}
	obj, err := c.Fake.
		Invokes(testing.NewRootGetActionWithOptions(policyrecommendationscopesResource, name, options), emptyResult)
	if obj == nil {
...
func (c *FakePolicyRecommendationScopes) List(ctx context.Context, opts v1.ListOptions) (result *v3.PolicyRecommendationScopeList, err error) {
	emptyResult := &v3.PolicyRecommendationScopeList{}
	obj, err := c.Fake.
		Invokes(testing.NewRootListActionWithOptions(policyrecommendationscopesResource, policyrecommendationscopesKind, opts), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
...
func (c *FakePolicyRecommendationScopes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchActionWithOptions(policyrecommendationscopesResource, opts))
}
...
func (c *FakePolicyRecommendationScopes) Create(ctx context.Context, policyRecommendationScope *v3.PolicyRecommendationScope, opts v1.CreateOptions) (result *v3.PolicyRecommendationScope, err error) {
	emptyResult := &v3.PolicyRecommendationScope{}
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateActionWithOptions(policyrecommendationscopesResource, policyRecommendationScope, opts), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(*v3.PolicyRecommendationScope), err
...
func (c *FakePolicyRecommendationScopes) Update(ctx context.Context, policyRecommendationScope *v3.PolicyRecommendationScope, opts v1.UpdateOptions) (result *v3.PolicyRecommendationScope, err error) {
	emptyResult := &v3.PolicyRecommendationScope{}
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateActionWithOptions(policyrecommendationscopesResource, policyRecommendationScope, opts), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(*v3.PolicyRecommendationScope), err
...
func (c *FakePolicyRecommendationScopes) UpdateStatus(ctx context.Context, policyRecommendationScope *v3.PolicyRecommendationScope, opts v1.UpdateOptions) (result *v3.PolicyRecommendationScope, err error) {
	emptyResult := &v3.PolicyRecommendationScope{}
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceActionWithOptions(policyrecommendationscopesResource, "status", policyRecommendationScope, opts), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(*v3.PolicyRecommendationScope), err
...
func (c *FakePolicyRecommendationScopes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionActionWithOptions(policyrecommendationscopesResource, opts, listOpts)
...
func (c *FakePolicyRecommendationScopes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v3.PolicyRecommendationScope, err error) {
	emptyResult := &v3.PolicyRecommendationScope{}
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceActionWithOptions(policyrecommendationscopesResource, name, pt, data, opts, subresources...), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(*v3.PolicyRecommendationScope), err

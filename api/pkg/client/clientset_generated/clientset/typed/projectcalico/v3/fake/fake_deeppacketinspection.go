...
func (c *FakeDeepPacketInspections) Get(ctx context.Context, name string, options v1.GetOptions) (result *v3.DeepPacketInspection, err error) {
	emptyResult := &v3.DeepPacketInspection{}
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithOptions(deeppacketinspectionsResource, c.ns, name, options), emptyResult)
...
func (c *FakeDeepPacketInspections) List(ctx context.Context, opts v1.ListOptions) (result *v3.DeepPacketInspectionList, err error) {
	emptyResult := &v3.DeepPacketInspectionList{}
	obj, err := c.Fake.
		Invokes(testing.NewListActionWithOptions(deeppacketinspectionsResource, deeppacketinspectionsKind, c.ns, opts), emptyResult)
...
func (c *FakeDeepPacketInspections) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchActionWithOptions(deeppacketinspectionsResource, c.ns, opts))
...
func (c *FakeDeepPacketInspections) Create(ctx context.Context, deepPacketInspection *v3.DeepPacketInspection, opts v1.CreateOptions) (result *v3.DeepPacketInspection, err error) {
	emptyResult := &v3.DeepPacketInspection{}
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithOptions(deeppacketinspectionsResource, c.ns, deepPacketInspection, opts), emptyResult)
...
func (c *FakeDeepPacketInspections) Update(ctx context.Context, deepPacketInspection *v3.DeepPacketInspection, opts v1.UpdateOptions) (result *v3.DeepPacketInspection, err error) {
	emptyResult := &v3.DeepPacketInspection{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithOptions(deeppacketinspectionsResource, c.ns, deepPacketInspection, opts), emptyResult)
...
func (c *FakeDeepPacketInspections) UpdateStatus(ctx context.Context, deepPacketInspection *v3.DeepPacketInspection, opts v1.UpdateOptions) (result *v3.DeepPacketInspection, err error) {
	emptyResult := &v3.DeepPacketInspection{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithOptions(deeppacketinspectionsResource, "status", c.ns, deepPacketInspection, opts), emptyResult)
...
func (c *FakeDeepPacketInspections) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionActionWithOptions(deeppacketinspectionsResource, c.ns, opts, listOpts)
...
func (c *FakeDeepPacketInspections) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v3.DeepPacketInspection, err error) {
	emptyResult := &v3.DeepPacketInspection{}
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithOptions(deeppacketinspectionsResource, c.ns, name, pt, data, opts, subresources...), emptyResult)

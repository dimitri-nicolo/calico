...
type FelixConfigurationSpec struct {
	...
	// BPFPBufferSize in BPF mode, controls the buffer size used for sending BPF events to felix.
	// [Default: 1<<20]
	BPFPerfBufferSize *int `json:"bpfPerfBufferSize,omitempty" validate:"omitempty,cidrs"`

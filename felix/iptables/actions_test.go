...
var _ = DescribeTable("Actions",
	...
	Entry("SaveConnMarkAction", Features{}, SaveConnMarkAction{SaveMask: 0x100}, "--jump CONNMARK --save-mark --mask 0x100"),
	Entry("RestoreConnMarkAction", Features{}, RestoreConnMarkAction{RestoreMask: 0x100}, "--jump CONNMARK --restore-mark --mask 0x100"),
	Entry("SaveConnMarkAction", Features{}, SaveConnMarkAction{}, "--jump CONNMARK --save-mark --mask 0xffffffff"),
	Entry("RestoreConnMarkAction", Features{}, RestoreConnMarkAction{}, "--jump CONNMARK --restore-mark --mask 0xffffffff"),
)

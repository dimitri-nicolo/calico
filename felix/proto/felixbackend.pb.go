...
type WAFEvent struct {
	...
	Rules     []*WAFRuleHit              `protobuf:"bytes,7,rep,name=rules" json:"rules,omitempty"`
	Action    string                     `protobuf:"bytes,8,opt,name=action,proto3" json:"action,omitempty"`
	Request   *HTTPRequest               `protobuf:"bytes,9,opt,name=request" json:"request,omitempty"`
	Timestamp *google_protobuf.Timestamp `protobuf:"bytes,10,opt,name=timestamp" json:"timestamp,omitempty"`
}

func (m *WAFEvent) Reset()                    { *m = WAFEvent{} }
func (m *WAFEvent) String() string            { return proto1.CompactTextString(m) }
func (*WAFEvent) ProtoMessage()               {}
func (*WAFEvent) Descriptor() ([]byte, []int) { return fileDescriptorFelixbackend, []int{95} }

func (m *WAFEvent) GetTxId() string {
	if m != nil {
		return m.TxId
	}
	return ""
...
func (m *WAFEvent) GetHost() string {
	if m != nil {
		return m.Host
	}
	return ""
...
func (m *WAFEvent) GetSrcIp() string {
	if m != nil {
		return m.SrcIp
	}
	return ""
...
func (m *WAFEvent) GetSrcPort() int32 {
	if m != nil {
		return m.SrcPort
	}
	return 0
...
func (m *WAFEvent) GetDstIp() string {
	if m != nil {
		return m.DstIp
	}
	return ""
...
func (m *WAFEvent) GetDstPort() int32 {
	if m != nil {
		return m.DstPort
	}
	return 0
...
func (m *WAFEvent) GetRules() []*WAFRuleHit {
	if m != nil {
		return m.Rules
	}
	return nil
...
func (m *WAFEvent) GetAction() string {
	if m != nil {
		return m.Action
	}
	return ""
...
func (m *WAFEvent) GetRequest() *HTTPRequest {
	if m != nil {
		return m.Request
	}
	return nil
...
func (m *WAFEvent) GetTimestamp() *google_protobuf.Timestamp {
	if m != nil {
		return m.Timestamp
	}
	return nil
...
func (m *WAFRule) Reset()                    { *m = WAFRule{} }
func (m *WAFRule) String() string            { return proto1.CompactTextString(m) }
func (*WAFRule) ProtoMessage()               {}
func (*WAFRule) Descriptor() ([]byte, []int) { return fileDescriptorFelixbackend, []int{96} }

func (m *WAFRule) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *WAFRule) GetMessage() string {
	if m != nil {
		return m.Message
	}
	return ""
...
func (m *WAFRule) GetSeverity() string {
	if m != nil {
		return m.Severity
	}
	return ""
...
type WAFRuleHit struct {
	Rule       *WAFRule `protobuf:"bytes,1,opt,name=rule" json:"rule,omitempty"`
	Disruptive bool     `protobuf:"varint,6,opt,name=disruptive,proto3" json:"disruptive,omitempty"`
}

func (m *WAFRuleHit) Reset()                    { *m = WAFRuleHit{} }
func (m *WAFRuleHit) String() string            { return proto1.CompactTextString(m) }
func (*WAFRuleHit) ProtoMessage()               {}
func (*WAFRuleHit) Descriptor() ([]byte, []int) { return fileDescriptorFelixbackend, []int{97} }

func (m *WAFRuleHit) GetRule() *WAFRule {
	if m != nil {
		return m.Rule
	}
	return nil
...
func (m *WAFRuleHit) GetDisruptive() bool {
	if m != nil {
		return m.Disruptive
	}
	return false
...
func (*HTTPRequest) Descriptor() ([]byte, []int) { return fileDescriptorFelixbackend, []int{98} }
...
func (m *WAFEventResult) Reset()                    { *m = WAFEventResult{} }
func (m *WAFEventResult) String() string            { return proto1.CompactTextString(m) }
func (*WAFEventResult) ProtoMessage()               {}
func (*WAFEventResult) Descriptor() ([]byte, []int) { return fileDescriptorFelixbackend, []int{99} }

func (m *WAFEventResult) GetSuccessful() bool {
	if m != nil {
		return m.Successful
	}
	return false
...
func init() {
	...
	proto1.RegisterType((*WAFEvent)(nil), "felix.WAFEvent")
	proto1.RegisterType((*WAFRule)(nil), "felix.WAFRule")
	proto1.RegisterType((*WAFRuleHit)(nil), "felix.WAFRuleHit")
	proto1.RegisterType((*HTTPRequest)(nil), "felix.HTTPRequest")
	proto1.RegisterType((*WAFEventResult)(nil), "felix.WAFEventResult")
...
type PolicySyncClient interface {
	...
	ReportWAF(ctx context.Context, opts ...grpc.CallOption) (PolicySync_ReportWAFClient, error)
}
...
func (c *policySyncClient) ReportWAF(ctx context.Context, opts ...grpc.CallOption) (PolicySync_ReportWAFClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_PolicySync_serviceDesc.Streams[1], c.cc, "/felix.PolicySync/ReportWAF", opts...)
	if err != nil {
		return nil, err
	}
	x := &policySyncReportWAFClient{stream}
	return x, nil
}

type PolicySync_ReportWAFClient interface {
	Send(*WAFEvent) error
	CloseAndRecv() (*WAFEventResult, error)
	grpc.ClientStream
}

type policySyncReportWAFClient struct {
	grpc.ClientStream
}

func (x *policySyncReportWAFClient) Send(m *WAFEvent) error {
	return x.ClientStream.SendMsg(m)
}

func (x *policySyncReportWAFClient) CloseAndRecv() (*WAFEventResult, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(WAFEventResult)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type PolicySyncServer interface {
	...
	// Report WAF events to Felix.
	ReportWAF(PolicySync_ReportWAFServer) error
}
...
func _PolicySync_ReportWAF_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(PolicySyncServer).ReportWAF(&policySyncReportWAFServer{stream})
}

type PolicySync_ReportWAFServer interface {
	SendAndClose(*WAFEventResult) error
	Recv() (*WAFEvent, error)
	grpc.ServerStream
}

type policySyncReportWAFServer struct {
	grpc.ServerStream
}

func (x *policySyncReportWAFServer) SendAndClose(m *WAFEventResult) error {
	return x.ServerStream.SendMsg(m)
}

func (x *policySyncReportWAFServer) Recv() (*WAFEvent, error) {
	m := new(WAFEvent)
...
func (m *WAFEvent) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *WAFEvent) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.TxId) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintFelixbackend(dAtA, i, uint64(len(m.TxId)))
		i += copy(dAtA[i:], m.TxId)
	}
	if len(m.Host) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintFelixbackend(dAtA, i, uint64(len(m.Host)))
	...
	if m.Request != nil {
		dAtA[i] = 0x4a
		i++
		i = encodeVarintFelixbackend(dAtA, i, uint64(m.Request.Size()))
		n116, err := m.Request.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n116
	...
	if m.Timestamp != nil {
		dAtA[i] = 0x52
		i++
		i = encodeVarintFelixbackend(dAtA, i, uint64(m.Timestamp.Size()))
...
func (m *WAFRule) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *WAFRule) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.Severity) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintFelixbackend(dAtA, i, uint64(len(m.Severity)))
		i += copy(dAtA[i:], m.Severity)
	}
	if len(m.File) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintFelixbackend(dAtA, i, uint64(len(m.File)))
		i += copy(dAtA[i:], m.File)
	}
	if len(m.Line) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintFelixbackend(dAtA, i, uint64(len(m.Line)))
		i += copy(dAtA[i:], m.Line)
	}
	return i, nil
}

func (m *WAFRuleHit) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *WAFRuleHit) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Rule != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintFelixbackend(dAtA, i, uint64(m.Rule.Size()))
		n118, err := m.Rule.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n118
...
func (m *HTTPRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Method) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintFelixbackend(dAtA, i, uint64(len(m.Method)))
		i += copy(dAtA[i:], m.Method)
	}
	if len(m.Path) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintFelixbackend(dAtA, i, uint64(len(m.Path)))
		i += copy(dAtA[i:], m.Path)
	}
	if len(m.Version) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintFelixbackend(dAtA, i, uint64(len(m.Version)))
...
func (m *WAFEventResult) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *WAFEventResult) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *WAFEventResult) Size() (n int) {
	var l int
	_ = l
	if m.Successful {
		n += 2
...
func (m *WAFEvent) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: WAFEvent: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: WAFEvent: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 7:
			...
			m.Rules = append(m.Rules, &WAFRuleHit{})
			if err := m.Rules[len(m.Rules)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *WAFRule) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: WAFRule: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: WAFRule: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *WAFRuleHit) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: WAFRuleHit: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: WAFRuleHit: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Disruptive", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *WAFEventResult) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: WAFEventResult: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: WAFEventResult: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
var fileDescriptorFelixbackend = []byte{
	...
	,
}

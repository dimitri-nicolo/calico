...
var (
	...
	approvedPkgs = set.FromArray([]pkgInfo{
		...
		{pkgName: "github.com/projectcalico/calico/felix/vendor/gopkg.in/inf.v0",
			license: "BSD 3-clause \"New\" or \"Revised\" License (97%)"},
		{pkgName: "github.com/projectcalico/calico/felix/vendor/gopkg.in/square/go-jose.v2/json",
			license: "BSD 3-clause \"New\" or \"Revised\" License (96%)"},
		{pkgName: "github.com/projectcalico/calico/felix/vendor/github.com/dustin/go-humanize",
			license: "MIT License (96%)"},
		{pkgName: "github.com/projectcalico/calico/felix/vendor/github.com/google/gopacket/layers",
			license: "BSD 3-clause \"New\" or \"Revised\" License (96%)"},
		{pkgName: "github.com/projectcalico/calico/felix/vendor/github.com/Masterminds/semver",
			license: "MIT License (98%)"},
		{pkgName: "github.com/projectcalico/calico/felix/vendor/github.com/Masterminds/sprig",
			license: "MIT License (98%)"},
		{pkgName: "github.com/projectcalico/calico/felix/vendor/github.com/google/uuid",
			license: "BSD 3-clause \"New\" or \"Revised\" License (96%)"},
		...
		{pkgName: "github.com/projectcalico/calico/felix/vendor/github.com/vishvananda/netns",
			license: "Apache License 2.0 (96%)"},
		{pkgName: "github.com/projectcalico/calico/felix/vendor/github.com/jmespath/go-jmespath",
	...
	approvedPrefixes = []string{
		...
		"github.com/projectcalico/calico/felix/packrd",
	}
)
...
lineLoop:
	for scanner.Scan() {
		...
		if strings.HasPrefix(pkgName, "github.com/projectcalico/calico/felix/vendor/github.com/tigera/") ||
			(strings.HasPrefix(pkgName, "github.com/projectcalico/calico/") &&
				!strings.Contains(pkgName, "vendor")) {
			logCxt.Info("One of our packages")
			continue

...
func TestMatchRule(t *testing.T) {
	...
	addIPSet(store, "src0", srcAddr+"/32")
	addIPSet(store, "src1", srcAddr+"/32", dstAddr+"/32")
	addIPSet(store, "notSrc0", "5.6.7.8/32", dstAddr+"/32")
	addIPSet(store, "notSrc1", "5.6.7.8/32")
	addIPSet(store, "dst0", dstAddr+"/32")
	addIPSet(store, "dst1", srcAddr+"/32", dstAddr+"/32")
	addIPSet(store, "notDst0", "5.6.7.8/32")
	addIPSet(store, "notDst1", "5.6.7.8/32", srcAddr+"/32")

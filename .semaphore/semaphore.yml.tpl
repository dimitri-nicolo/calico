...
- name: "apiserver"
  run:
    when: "${BRANCH_RESTRICTION} or change_in(['/*', '/api/', '/apiserver/', '/licensing/'], {exclude: ['/**/.gitignore', '/**/README.md', '/**/LICENSE']})"
  execution_time_limit:
    minutes: 30
  dependencies: []
  task:
...
- name: "libcalico-go"
  run:
    when: "${BRANCH_RESTRICTION} or change_in(['/*', '/api/', '/libcalico-go/'], {exclude: ['/**/.gitignore', '/**/README.md', '/**/LICENSE']})"
  dependencies: []
  task:
    jobs:
...
- name: "Typha"
  run:
    when: "${BRANCH_RESTRICTION} or change_in(['/*', '/api/', '/libcalico-go/', '/typha/'], {exclude: ['/**/.gitignore', '/**/README.md', '/**/LICENSE']})"
  dependencies: []
  task:
    agent:
      machine:
...
- name: "Felix: Build"
  run:
    when: "${BRANCH_RESTRICTION} or change_in(['/*', '/api/', '/libcalico-go/', '/typha/', '/felix/'], {exclude: ['/**/.gitignore', '/**/README.md', '/**/LICENSE']})"
  dependencies: []
  task:
    agent:
      machine:
...
- name: "confd: tests"
  run:
    when: "${BRANCH_RESTRICTION} or change_in(['/*', '/api/', '/libcalico-go/', '/confd/'], {exclude: ['/**/.gitignore', '/**/README.md', '/**/LICENSE']})"
  dependencies: []
  task:
    prologue:
      commands:
...
- name: "Node: Tests"
  run:
    when: "${BRANCH_RESTRICTION} or change_in(['/*', '/api/', '/libcalico-go/', '/typha/', '/felix/', '/confd/', '/bird/', '/pod2daemon/', '/node/', '/licensing/'], {exclude: ['/**/.gitignore', '/**/README.md', '/**/LICENSE']})"
  dependencies: []
  task:
    agent:
      machine:
...
- name: "kube-controllers: Tests"
  run:
    when: "${BRANCH_RESTRICTION} or change_in(['/*', '/api/', '/libcalico-go/', '/kube-controllers/', '/licensing/'], {exclude: ['/**/.gitignore', '/**/README.md', '/**/LICENSE']})"
  dependencies: []
  task:
    prologue:
      commands:
...
- name: "pod2daemon"
  run:
    when: "${BRANCH_RESTRICTION} or change_in(['/*', '/pod2daemon/'], {exclude: ['/**/.gitignore', '/**/README.md', '/**/LICENSE']})"
  dependencies: []
  task:
    prologue:
      commands:
...
- name: "app-policy"
  run:
    when: "${BRANCH_RESTRICTION} or change_in(['/*', '/app-policy/', '/felix/', '/licensing/'], {exclude: ['/**/.gitignore', '/**/README.md', '/**/LICENSE']})"
  dependencies: []
  task:
    prologue:
      commands:
...
- name: "calicoctl"
  run:
    when: "${BRANCH_RESTRICTION} or change_in(['/*', '/calicoctl/', '/libcalico-go/', '/api/', '/licensing/'], {exclude: ['/**/.gitignore', '/**/README.md', '/**/LICENSE']})"
  dependencies: []
  task:
    prologue:
      commands:
...
- name: "cni-plugin: Windows"
  run:
    when: "${BRANCH_RESTRICTION} or change_in(['/*', '/cni-plugin/', '/libcalico-go/'], {exclude: ['/**/.gitignore', '/**/README.md', '/**/LICENSE']})"
  dependencies: []
  task:
    secrets:
    - name: banzai-secrets
...
- name: "licensing"
  run:
    when: "${BRANCH_RESTRICTION} or change_in(['/*', '/licensing/', '/libcalico-go/'], {exclude: ['/**/.gitignore', '/**/README.md', '/**/LICENSE']})"
  dependencies: []
  task:
    prologue:
      commands:
...
- name: "Documentation"
  run:
    when: "${BRANCH_RESTRICTION} or change_in(['/*', '/calico/'], {exclude: ['/**/.gitignore', '/**/README.md', '/**/LICENSE']})"
  dependencies: []
  task:
    prologue:
      commands:

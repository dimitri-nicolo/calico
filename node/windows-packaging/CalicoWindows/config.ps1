...
# Enable flowlogs. 
Set-EnvVarIfNotSet -var "FELIX_FLOWLOGSFILEENABLED" -defaultValue "true"
Set-EnvVarIfNotSet -var "FELIX_FLOWLOGSFILEINCLUDELABELS" -defaultValue "true"
Set-EnvVarIfNotSet -var "FELIX_FLOWLOGSFILEINCLUDEPOLICIES" -defaultValue "true"
Set-EnvVarIfNotSet -var "FELIX_FLOWLOGSFILEINCLUDESERVICE" -defaultValue "true"
Set-EnvVarIfNotSet -var "FELIX_FLOWLOGSENABLENETWORKSETS" -defaultValue "true"

# Enable Felix to keep track of denied packets and publish as prometheus
# metrics.
Set-EnvVarIfNotSet -var "FELIX_PROMETHEUSREPORTERENABLED" -defaultValue "true"
Set-EnvVarIfNotSet -var "FELIX_PROMETHEUSREPORTERPORT" -defaultValue "9081"

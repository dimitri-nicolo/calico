...
var _ = DescribeTable("DNS",
	...
	Entry("client_ip ipv4", Atom{Key: "client_ip", Value: "127.000.000.001"}, "127.0.0.1", true),
	...
	Entry("servers.ip ipv4", Atom{Key: "servers.ip", Value: "127.000.000.001"}, "127.0.0.1", true),

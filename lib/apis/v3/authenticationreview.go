...
// NewAuthenticationReviewList creates a new (zeroed) AuthenticationReviewList struct with the TypeMetadata
// initialized to the current version.
func NewAuthenticationReviewList() *AuthenticationReviewList {
	return &AuthenticationReviewList{
		TypeMeta: metav1.TypeMeta{
			Kind:       KindAuthenticationReviewList,
			APIVersion: apiv3.GroupVersionCurrent,
		},
	}
}

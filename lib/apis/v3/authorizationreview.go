...
// NewAuthorizationReviewList creates a new (zeroed) AuthorizationReviewList struct with the TypeMetadata
// initialized to the current version.
func NewAuthorizationReviewList() *AuthorizationReviewList {

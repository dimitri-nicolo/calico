			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"dnsLogsFlushInterval": {
						SchemaProps: spec.SchemaProps{
							Description: "DNSLogsFlushInterval configures the interval at which Felix exports DNS logs.",
							Ref:         ref("k8s.io/apimachinery/pkg/apis/meta/v1.Duration"),
						},
					},
					"dnsLogsFileEnabled": {
						SchemaProps: spec.SchemaProps{
							Description: "DNSLogsFileEnabled controls logging DNS logs to a file. If false no DNS logging to file will occur.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
					"dnsLogsFileMaxFiles": {
						SchemaProps: spec.SchemaProps{
							Description: "DNSLogsFileMaxFiles sets the number of DNS log files to keep.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"dnsLogsFileMaxFileSizeMB": {
						SchemaProps: spec.SchemaProps{
							Description: "DNSLogsFileMaxFileSizeMB sets the max size in MB of DNS log files before rotation.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"dnsLogsFileDirectory": {
						SchemaProps: spec.SchemaProps{
							Description: "DNSLogsFileDirectory sets the directory where DNS log files are stored.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"dnsLogsFileIncludeLabels": {
						SchemaProps: spec.SchemaProps{
							Description: "DNSLogsFileIncludeLabels is used to configure if endpoint labels are included in a DNS log entry written to file.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},

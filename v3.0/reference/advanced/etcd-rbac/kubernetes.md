...
- {{site.tseeprodname}}
  ...
  - {{site.tseeprodname}} uses the etcd v2 API so the user and roles must be created there
    too.
...
To deploy hosted {{site.tseeprodname}} with the CA and {{site.tseeprodname}}-specific certificate/key pair,

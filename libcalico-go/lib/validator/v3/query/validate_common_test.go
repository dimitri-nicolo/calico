...
var _ = Describe("Common", func() {
	...
	DescribeTable("IP",
		...
		Entry("ipv4 with leading zeroes", Atom{Value: "127.000.000.001"}, "127.0.0.1", true),
		...
		Entry("<", Atom{Comparator: CmpLt, Value: "127.0.0.1"}, "", false),
		Entry("<=", Atom{Comparator: CmpLte, Value: "127.0.0.1"}, "", false),
		Entry(">", Atom{Comparator: CmpGt, Value: "127.0.0.1"}, "", false),
		Entry(">=", Atom{Comparator: CmpGte, Value: "127.0.0.1"}, "", false),
		Entry("ipv4 cidr with leading zero", Atom{Value: "127.000.0.0/8"}, "127.0.0.0/8", true),

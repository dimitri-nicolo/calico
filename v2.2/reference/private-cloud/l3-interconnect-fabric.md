...
If a {{site.tseeprodname}} user is interested in the AS per compute server, we
...
In the {{site.tseeprodname}} [Ethernet fabric]({{site.baseurl}}/{{page.version}}/reference/private-cloud/l2-interconnect-fabric)

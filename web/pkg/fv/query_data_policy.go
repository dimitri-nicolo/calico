...
func policyTestQueryData() []testQueryData {
	...
	qcPolicy_gnp2_all_res := qcPolicy(gnp2_t1_o4, 4, 4, 4, 4)
	qcPolicy_gnp2_all_res.Egress[0].Source.NotSelector.NumHostEndpoints = 0
	qcPolicy_gnp2_all_res.Egress[0].Source.NotSelector.NumWorkloadEndpoints = 2
	qcPolicy_gnp2_all_res.Egress[1].Source.Selector.NumHostEndpoints = 1
	qcPolicy_gnp2_all_res.Egress[1].Source.Selector.NumWorkloadEndpoints = 1
	qcPolicy_gnp2_all_res.Ingress[0].Destination.Selector.NumHostEndpoints = 2
	qcPolicy_gnp2_all_res.Ingress[0].Destination.Selector.NumWorkloadEndpoints = 0
	qcPolicy_gnp2_all_res.Ingress[1].Destination.NotSelector.NumHostEndpoints = 2
	qcPolicy_gnp2_all_res.Ingress[1].Destination.NotSelector.NumWorkloadEndpoints = 3

	qcPolicy_gnp1_all_res_more := qcPolicy(gnp1_t1_o4_more_rules, 1, 3	, 4, 4)
	qcPolicy_gnp1_all_res_more.Egress[0].Source.NotSelector.NumHostEndpoints = 0
	qcPolicy_gnp1_all_res_more.Egress[0].Source.NotSelector.NumWorkloadEndpoints = 2
	qcPolicy_gnp1_all_res_more.Ingress[0].Destination.Selector.NumHostEndpoints = 2
	qcPolicy_gnp1_all_res_more.Ingress[0].Destination.Selector.NumWorkloadEndpoints = 0

	qcPolicy_gnp2_all_res_fewer := qcPolicy(gnp2_t1_o3_fewer_rules, 4, 4, 4, 4)
	qcPolicy_gnp2_all_res_fewer.Egress[0].Source.Selector.NumHostEndpoints = 1
	qcPolicy_gnp2_all_res_fewer.Egress[0].Source.Selector.NumWorkloadEndpoints = 1
	qcPolicy_gnp2_all_res_fewer.Ingress[0].Destination.NotSelector.NumHostEndpoints = 2
	qcPolicy_gnp2_all_res_fewer.Ingress[0].Destination.NotSelector.NumWorkloadEndpoints = 3

	qcPolicy_gnp1_all_res_more_updated_wep1 := qcPolicy(gnp1_t1_o4_more_rules, 1, 2, 4, 4)
	qcPolicy_gnp1_all_res_more_updated_wep1.Egress[0].Source.NotSelector.NumHostEndpoints = 0
	qcPolicy_gnp1_all_res_more_updated_wep1.Egress[0].Source.NotSelector.NumWorkloadEndpoints = 1
	qcPolicy_gnp1_all_res_more_updated_wep1.Ingress[0].Destination.Selector.NumHostEndpoints = 2
	qcPolicy_gnp1_all_res_more_updated_wep1.Ingress[0].Destination.Selector.NumWorkloadEndpoints = 1

	qcPolicy_gnp2_all_res_fewer_updated_wep1 := qcPolicy(gnp2_t1_o3_fewer_rules, 4, 4, 4, 4)
	qcPolicy_gnp2_all_res_fewer_updated_wep1.Egress[0].Source.Selector.NumHostEndpoints = 1
	qcPolicy_gnp2_all_res_fewer_updated_wep1.Egress[0].Source.Selector.NumWorkloadEndpoints = 1
	qcPolicy_gnp2_all_res_fewer_updated_wep1.Ingress[0].Destination.NotSelector.NumHostEndpoints = 2
	qcPolicy_gnp2_all_res_fewer_updated_wep1.Ingress[0].Destination.NotSelector.NumWorkloadEndpoints = 3
	...
	return []testQueryData{
		...
		},
		{
			...
			&client.QueryPoliciesResp{
				...
				Items: []client.Policy{
					...
					qcPolicy(gnp1_t1_o3, 1, 3, 4, 4), qcPolicy_gnp2_all_res,
					qcPolicy(np1_t2_o1_ns1, 0, 1, 4, 4), qcPolicy(np2_t2_o2_ns2, 0, 2, 4, 4),
					qcPolicy(gnp1_t2_o3, 1, 1, 4, 4), qcPolicy(gnp2_t2_o4, 4, 4, 4, 4),
				},
			},
		},
		{
			...
			&client.QueryPoliciesResp{
				...
				Items: []client.Policy{
					qcPolicy(np1_t1_o1_ns1, 0, 1, 4, 4), qcPolicy(np2_t1_o2_ns2, 0, 2, 4, 4),
					qcPolicy_gnp2_all_res_fewer, qcPolicy_gnp1_all_res_more,
					qcPolicy(np1_t2_o1_ns1, 0, 1, 4, 4), qcPolicy(np2_t2_o2_ns2, 0, 2, 4, 4),
					qcPolicy(gnp1_t2_o3, 1, 1, 4, 4), qcPolicy(gnp2_t2_o4, 4, 4, 4, 4),
				},
			},
		},
		{
			...
			&client.QueryPoliciesResp{
				...
				Items: []client.Policy{
					...
					qcPolicy_gnp2_all_res_fewer_updated_wep1, qcPolicy_gnp1_all_res_more_updated_wep1,
					qcPolicy(np1_t2_o1_ns1, 0, 1, 4, 4), qcPolicy(np2_t2_o2_ns2, 0, 2, 4, 4),
					qcPolicy(gnp1_t2_o3, 1, 1, 4, 4), qcPolicy(gnp2_t2_o4, 4, 4, 4, 4),
				},
			},

...
SEMAPHORE_AUTO_PIN_UPDATE_PROJECT_IDS=$(SEMAPHORE_API_SERVER_PROJECT_ID) $(SEMAPHORE_LICENSE_AGENT_PROJECT_ID) $(SEMAPHORE_CALICOCTL_PRIVATE_PROJECT_ID) $(SEMAPHORE_FELIX_PRIVATE_PROJECT_ID)

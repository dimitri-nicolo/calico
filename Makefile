...
CTL_CONTAINER_NAME?=tigera/calicoctl$(ARCHTAG)
...
ifndef VERSION
	...
	@echo "  docker push gcr.io/unique-caldron-775/cnx/tigera/calicoctl:$(VERSION)"
	@echo ""
	...
	@echo "  gcloud auth configure-docker"
	@echo "  docker push gcr.io/unique-caldron-775/cnx/tigera/calicoctl:latest"
	@echo ""

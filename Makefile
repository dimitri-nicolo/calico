...
SEMAPHORE_AUTO_PIN_UPDATE_PROJECT_IDS=$(SEMAPHORE_API_SERVER_PROJECT_ID) $(SEMAPHORE_CALICOCTL_PRIVATE_PROJECT_ID) $(SEMAPHORE_CNI_PLUGIN_PRIVATE_PROJECT_ID) $(SEMAPHORE_APP_POLICY_PRIVATE_PROJECT_ID) $(SEMAPHORE_TYPHA_PRIVATE_PROJECT_ID)

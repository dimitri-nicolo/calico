...
SEMAPHORE_AUTO_PIN_UPDATE_PROJECT_IDS=$(SEMAPHORE_DEEP_PACKET_INSPECTION_PROJECT_ID) $(SEMAPHORE_CONFD_PRIVATE_PROJECT_ID) $(SEMAPHORE_FELIX_PRIVATE_PROJECT_ID)

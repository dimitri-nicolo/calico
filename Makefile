...
SEMAPHORE_AUTO_PIN_UPDATE_PROJECT_IDS=$(SEMAPHORE_NODE_PRIVATE_PROJECT_ID) $(SEMAPHORE_TS_QUERYSERVER_PROJECT_ID) $(SEMAPHORE_HONEYPOD_CONTROLLER_PROJECT_ID) $(SEMAPHORE_KUBE_CONTROLLERS_PRIVATE_PROJECT_ID) $(SEMAPHORE_CALICOQ_PROJECT_ID) $(SEMAPHORE_CLOUD_CONTROLLERS_PRIVATE_PROJECT_ID) $(SEMAPHORE_COMPLIANCE_PROJECT_ID)

...
The endpoints from remote clusters appear in the output of the calicoq tool. They do not appear it either the the {{site.prodname}} manager or the calicoctl command lines tools.

...
canonical_url: https://docs.tigera.io/v2.1/getting-started/openshift/installation
---
...
openshift_use_openshift_sdn=false
calico_node_image=<YOUR-REGISTRY>/tigera/cnx-node:{{site.data.versions[page.version].first.components["cnx-node"].version}}
calico_url_policy_controller={{site.data.versions[page.version].first.dockerRepo}}/{{site.imageNames["calicoKubeControllers"]}}:{{site.data.versions[page.version].first.components["calico/kube-controllers"].version}}

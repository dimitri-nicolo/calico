def gen_values_v2_6(versions, _, imageRegistry, chart, forDocs)
    return gen_chart_specific_values_v2_6(versions, imageRegistry, chart, forDocs)
end


def gen_chart_specific_values_v2_6(versions, imageRegistry, chart, forDocs)

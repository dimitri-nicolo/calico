...
{{site.tseeprodname}} and that {{site.tseeprodname}} was installed using helm charts.
...
1. Delete the install Job from the previous {{site.tseeprodname}} install, if it exists
...
## Upgrading to {{page.version}} {{site.tseeprodname}} from a previous Helm install

If your {{site.tseeprodname}} was previously installed using helm, use the following
steps to upgrade.

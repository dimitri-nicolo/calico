...
{{site.tseeprodname}} [workload endpoints]({{site.url}}/{{page.version}}/reference/resources/workloadendpoint) will
...
When using {{site.tseeprodname}} IPAM, IP addresses are assigned from [IP Pools]({{site.url}}/{{page.version}}/reference/resources/ippool).

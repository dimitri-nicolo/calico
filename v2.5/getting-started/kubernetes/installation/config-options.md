...
{{site.tseeprodname}} IPAM assigns IP addresses from [IP pools]({{site.url}}/{{page.version}}/reference/resources/ippool).
...
1. Download the {{page.version}} manifest that corresponds to your installation method.
   ...
   **{{site.tseeprodname}} for policy and flannel for networking**
   ```bash
...
Refer to the
[{{site.tseeprodname}} ConfigMap manifest](/{{page.version}}/manifests/alp/istio-inject-configmap-1.0.7.yaml){:target="_blank"} for an
